...
//OTA
#include "USE_JOB1.h"                                           //20240711

/*heartbeat*/
//#include "job1.h"                                                 //20240711

//串口发送                          com1_send_buf                             35
...
void HAL_UART_RxCpltCallback( UART_HandleTypeDef *huart )
{
	...
	//     {
	// //OTA BEGIN
	//          data_rx_buf[data_rx_con] = com1_recv_one_byte ;
	...
	{
		//接收到的数据存入环形缓冲区
		rb_write( &g_uart_rb, &com1_recv_one_byte, 1 );
		//等待下一次接收中断
		HAL_UART_Receive_IT( huart, &com1_recv_one_byte, 1 );
	}
